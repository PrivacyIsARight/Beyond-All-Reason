...
-- common foggy cliffs
	if n%360 == 0 then
		...
		SpawnCEGInPositionGround("fogdirty-red", 4608, 300, 4608)
		SpawnCEGInPositionGround("fogdirty-red", 4608, 400, 4608)
		SpawnCEGInPositionGround("smokeblack", 4608, 400, 4608)
		SpawnCEGInPositionGround("smokeblack", 4608, 500, 4608)
